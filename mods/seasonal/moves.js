...
exports.BattleMovedex = {
	...
	energyfield: {
		...
		basePower: 150,
		category: "Special",
		shortDesc: "Lowers user's Defense, Sp. Def and Speed by 1, 40% chance to paralyze target.",
		id: "energyfield",
		isNonstandard: true,
		isViable: true,
		name: "Energy Field",
	...
	pilfer: {
		...
		basePower: 90,
		category: "Physical",
		shortDesc: "Copies opponents status move.",
		id: "pilfer",
		isNonstandard: true,
		name: "Pilfer",
		pp: 5,
	...
	starboltdesperation: {
		...
		basePower: 0,
		category: "Physical",
		shortDesc: "1/4 target's HP. 50% random status. 50% confusion. Raises and lowers a random stat from user.",
	...
	nextlevelstrats: {
		accuracy: true,
		category: "Status",
		shortDesc: "Boosts max level in 5",
		id: "nextlevelstrats",
		isNonstandard: true,
	...
	ragequit: {
		...
		basePower: 0,
		category: "Status",
		shortDesc: "Just like splash, but it insta defeats",
		id: "ragequit",
		name: "Rage Quit",
		pp: 40,
		priority: 0,
	...
	maelstrm: {
		...
		basePower: 100,
		category: "Special",
		shortsDesc: " Partial trapping move, persists even when user is not in play.",
		id: "maelstrm",
		name: "Maelström",
		pp: 5,
		priority: 0,
	...
	spoopyedgecut: {
		...
		basePower: 80,
		category: "Physical",
		shortDesc: "Sharply lowers own accuracy.",
		id: "spoopyedgecut",
		isViable: true,
		isNonstandard: true,
	...
	eventhorizon: {
		...
		priority: 0,
		category: "Special",
		shortDesc: "Adds Trick Room. Deals damage.",
		id: "eventhorizon",
		isViable: true,
		isNonstandard: true,
		name: "Event Horizon",
