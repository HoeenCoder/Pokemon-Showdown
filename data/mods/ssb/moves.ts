...
export const Moves: {[k: string]: ModdedMoveData} = {
	...
	*/
	...
	updraft: {
		...
		basePower: 75,
		category: "Special",
		desc: "100 % accurate in rain / tempest, changes target's secondary typing to Flying for 2-5 turns. If opponent is a non- Flying monotype, adds Flying as a secondary typing. Secondary effects fail if the target is Ground- type or affected by Ingrain.",
		shortDesc: "IDK how to shortDesc this.",
		name: "Updraft",
		isNonstandard: "Custom",
		gen: 8,
		pp: 10,
