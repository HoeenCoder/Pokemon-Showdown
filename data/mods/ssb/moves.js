...
let BattleMovedex = {
	...
	*/
	...
	compost: {
		...
		basePower: 0,
		category: "Status",
		desc: "The user recovers half its HP. If any Pokemon fainted the previous turn, this move heals the active Pokemon by 50% of the user's HP on the following turn. Cures the user's party of all status conditions. The terrain becomes Grassy Terrain.",
		shortDesc: "Heal, Grassy Terrain, Heal Bell; any fainted: Wish.",
		id: "compost",
		name: "Compost",
		isNonstandard: "Custom",
		pp: 5,
